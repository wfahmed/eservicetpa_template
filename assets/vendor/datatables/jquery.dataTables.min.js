...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"الأول",sLast:"الأخير",sNext:"التالي",sPrevious:"السابق"},sEmptyTable:"لا يوجد بيانات متاحة",sInfo:"عرض _START_ إلى _END_ من _TOTAL_ سجل",sInfoEmpty:"Showing 0 to 0 of 0 entries",
sInfoFiltered:"(تم تصفيته _MAX_ total سجلات)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"عرض _MENU_ سجلات",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"ابحث:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:h.extend({},n.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
